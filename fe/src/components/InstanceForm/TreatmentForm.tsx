                        ...
                        <Row gutter={[16, 16]}>
                            <Col span={12}>
                                <Form.Item
                                    ...
                                    name={`instance_start_date${treatmentId}`} // Add the name prop to connect with the form field
                            ...
                            <Col span={12}>
                                <Form.Item
                                    ...
                                    name={`instance_end_date${treatmentId}`} // Add the name prop to connect with the form field
